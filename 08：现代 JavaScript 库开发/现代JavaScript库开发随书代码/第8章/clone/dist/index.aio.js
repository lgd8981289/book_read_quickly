...
(function (global, factory) {
	...
	function type(x) {
	  ...
	  var innerLowType = cls.toLowerCase(); // 区分 String() 和 new String()
	...
	function cloneJSON(x) {
	  ...
	  try {
	    return JSON.parse(stringify$1(x));
	  } catch (e) {
	    if (errOrDef === true) {
	      throw e;
	    } else {
	...
	function getWeakMap() {
	  ...
	  if (typeof weakMap$1 !== 'undefined' && type(weakMap$1) == 'function') {
	    result = new weakMap$1();
